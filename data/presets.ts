...
export const PRESETS_BY_MODE: Record<VisualizerMode, Preset[]> = {
  ...
  [VisualizerMode.BARS]: [
    { id: 'bars-1', name: 'Bars 1', videoUrl: '', config: createConfig({ mode: VisualizerMode.BARS, color: '#FFFFFF', sensitivity: 2.1, bars: { waves: 5, width: 25, spacing: 16, amplitude: 56, height: 25, roundness: 92, moving: false } }) },
